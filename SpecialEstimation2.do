...
*****************************************************************
* PROCEDURE CHRISTOPHE (par Céline (20/07/2014) pour récupérer les prix 2008 par région)
*****************************************************************
...
sort country region
merge country region using data\OECD2008_index.dta
tab _merge
...
/*ESSAI SPECIAL = PRIX_2008 (prog Céline 20/07/2014)  */ 
...
global exog "i_under18 log_income i_town i_car b08_locenv_water a2_age i_can i_fra i_net i_swe"
