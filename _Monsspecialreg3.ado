...
/* Programm modified to use bandwidthchoices when computing bootstrap accorting to Monsspecialreg2.ado  */

program define _Monsspecialreg3, rclass
version 11.0
syntax varlist, TOUSE(string) ENDOG(string) IV(string) ///
    EXOG(string) HETERO(string) HETV(string) KDENS(string) BAND(string)  TRIM(string) [WINSOR(string)]
...
/* Changing the default by commands used in Monsspecialreg3.ado */
	if "`kdens'" == "kdens" {
