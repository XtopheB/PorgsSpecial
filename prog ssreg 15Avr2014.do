...
*/ + _b[log_income]*log_income + _b[i_town]*i_town + _b[i_car]*i_car + _b[b08_locenv_water]*b08_locenv_water /*
*/ + _b[i_can]*i_can + _b[i_fra]*i_fra + _b[i_net]*i_net + _b[i_swe]*i_swe + _b[_cons]
...
summ xbeta_kdens xbeta_sorted d08_kmdriven_wk_impute if e(sample), d
...
global exog "i_under18 a2_age i_town i_car b08_locenv_water i_can i_fra i_net i_swe"
global endog "isatis_health"
global instrument "itap_2008 iconcernwatpol_2008"
...
gen xbeta_kdens = _b[isatis_health]*isatis_health + _b[i_under18]*i_under18 + _b[a2_age]*a2_age /*
*/ + _b[i_town]*i_town + _b[i_car]*i_car + _b[b08_locenv_water]*b08_locenv_water + _b[i_can]*i_can /*
*/ + _b[i_fra]*i_fra + _b[i_net]*i_net + _b[i_swe]*i_swe + _b[_cons]
...
gen xbeta_sorted = _b[isatis_health]*isatis_health + _b[i_under18]*i_under18 + _b[a2_age]*a2_age /*
*/ + _b[i_town]*i_town + _b[i_car]*i_car + _b[b08_locenv_water]*b08_locenv_water + _b[i_can]*i_can /*
*/ + _b[i_fra]*i_fra + _b[i_net]*i_net + _b[i_swe]*i_swe + _b[_cons]
