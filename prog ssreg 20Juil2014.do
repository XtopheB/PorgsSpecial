...
sort country region
merge m:m country region using "C:\Celine\annee11\OCDE\données\OECD2008_index.dta"
tab _merge

keep if country~=. & region~=.
sort country region a0000_respondentid

keep country region i_tap prix_2008 i_under18 log_income lowincome i_town i_car b08_locenv_water a2_age isatis_health /*
*/ itap_2008 iconcernwatpol_2008

save "C:\Celine\annee14\Christophe\table for ssreg.dta", replace
...
use "C:\Celine\annee14\Christophe\table for ssreg.dta", clear

* Variables du modèle 

* Special regresseur = PRIX_2008 
...
*global exog "i_under18 lowincome i_town i_car b08_locenv_water a2_age i_can i_fra"
...
*/ kdens trim(2.5) bs bsreps(10)


discard
sspecialreg i_tap Special, exog($exog) endog($endog) iv($instrument) /*
*/ hetero hetv(i_under18 log_income i_town b08_locenv_water) /*
*/ trim(2.5) bs bsreps(10)
...
sspecialreg i_tap Special, exog($exog) endog($endog) iv($instrument) /*
*/ hetero hetv(i_under18 log_income i_town b08_locenv_water) /*
*/ kdens trim(2.5) bs bsreps(250)


discard
sspecialreg i_tap Special, exog($exog) endog($endog) iv($instrument) /*
*/ hetero hetv(i_under18 log_income i_town b08_locenv_water) /*
*/ trim(2.5) bs bsreps(250)
...
xi: probit i_tap a2_age totwaste i_under18 log_income i_town i_car isatis_health b08_locenv_water i.country 
lstat
margins, dydx(*) predict(pr)

* BIPROBIT

xi: biprobit (i_tap a2_age totwaste i_under18 log_income i_town i_car isatis_health b08_locenv_water i.country) /*
*/ (isatis_health a2_age totwaste i_under18 log_income i_town i_car b08_locenv_water i.country itap_2008 iconcernwatpol_2008)
...
xi: ivprobit i_tap a2_age totwaste i_under18 log_income i_town i_car b08_locenv_water i.country /*
*/ (isatis_health = itap_2008 iconcernwatpol_2008)
...
gen ltotwaste = log(totwaste)
egen m_ltotwaste = mean(ltotwaste)
replace ltotwaste = -(ltotwaste - m_ltotwaste)

egen gr_waste = group(totwaste)

*drop totwaste
*gen totwaste = gr_waste

gen Special = ltotwaste

*egen Specialp10 = pctile(Special), p(10)
*egen Specialp90 = pctile(Special), p(90)

*summ i_tap if Special <= Specialp10
*summ i_tap if Special >= Specialp90

*drop isatis_health
*gen isatis_health = g8_wtrstfcn_health
...
gen xbeta_kdens = _b[isatis_health]*isatis_health + _b[a2_age]*a2_age + _b[i_under18]*i_under18 /*
*/ + _b[log_income]*log_income + _b[i_town]*i_town + _b[i_car]*i_car /*
*/ + _b[b08_locenv_water]*b08_locenv_water + _b[i_can]*i_can + _b[i_fra]*i_fra + _b[i_net]*i_net /*
*/ + _b[i_swe]*i_swe + _b[_cons] 
...
gen xbeta_sorted = _b[isatis_health]*isatis_health + _b[a2_age]*a2_age + _b[i_under18]*i_under18 /*
*/ + _b[log_income]*log_income + _b[i_town]*i_town + _b[i_car]*i_car /*
*/ + _b[b08_locenv_water]*b08_locenv_water + _b[i_can]*i_can + _b[i_fra]*i_fra + _b[i_net]*i_net /*
*/ + _b[i_swe]*i_swe + _b[_cons]

summ xbeta_kdens xbeta_sorted totwaste if e(sample), d


discard
sspecialreg i_tap Special, exog($exog) endog($endog) iv($instrument) /*
*/ hetero hetv(i_under18 log_income i_town b08_locenv_water) /*
*/ kdens trim(2.5) bs bsreps(100)


discard
sspecialreg i_tap Special, exog($exog) endog($endog) iv($instrument) /*
*/ hetero hetv(i_under18 log_income i_town b08_locenv_water) /*
*/ trim(2.5) bs bsreps(100)
...
xi: probit i_tap a2_age i_under18 log_income i_town i_car b08_locenv_water i_can i_fra i_net i_swe /*
*/ Special isatis_health 
lstat
margins, dydx(*) predict(pr)

* BIPROBIT

xi: biprobit (i_tap a2_age i_under18 log_income i_town i_car b08_locenv_water i_can i_fra i_net i_swe /*
*/ Special isatis_health) /*
*/ (isatis_health a2_age i_under18 log_income i_town i_car b08_locenv_water i_can i_fra i_net i_swe /*
*/ Special itap_2008 iconcernwatpol_2008)
...
xi: ivprobit i_tap a2_age i_under18 log_income i_town i_car b08_locenv_water i_can i_fra i_net i_swe /*
*/ Special (isatis_health = itap_2008 iconcernwatpol_2008)
...
* Special regresseur = LOG INCOME 

set seed 1111

gen Special= log_income
*gen Special= a8_inceur_imp
...
global exog "i_under18 a2_age totwaste i_town i_car b08_locenv_water i_can i_fra i_net i_swe"
global endog "isatis_health"
global instrument "itap_2008 iconcernwatpol_2008"
...
gen xbeta_kdens = _b[isatis_health]*isatis_health + _b[totwaste]*totwaste + _b[i_under18]*i_under18 + _b[a2_age]*a2_age /*
*/ + _b[i_town]*i_town + _b[i_car]*i_car + _b[b08_locenv_water]*b08_locenv_water + _b[i_can]*i_can /*
*/ + _b[i_fra]*i_fra + _b[i_net]*i_net + _b[i_swe]*i_swe + _b[_cons]
...
gen xbeta_sorted = _b[isatis_health]*isatis_health + _b[totwaste]*totwaste + _b[i_under18]*i_under18 + _b[a2_age]*a2_age /*
*/ + _b[i_town]*i_town + _b[i_car]*i_car + _b[b08_locenv_water]*b08_locenv_water + _b[i_can]*i_can /*
*/ + _b[i_fra]*i_fra + _b[i_net]*i_net + _b[i_swe]*i_swe + _b[_cons]

summ xbeta_kdens xbeta_sorted log_income if e(sample), d


discard
sspecialreg i_tap Special, exog($exog) endog($endog) iv($instrument) /*
*/ hetero hetv(i_under18 a2_age i_town b08_locenv_water) /*
*/ kdens trim(2.5) bs bsreps(250)
